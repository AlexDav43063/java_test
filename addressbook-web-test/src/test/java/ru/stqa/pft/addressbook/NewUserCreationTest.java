...
public class NewUserCreationTest {
  ...
  public void testNewUserCreation() throws Exception {
    initNewUser();
    fillNewUserForm(new UserData("Name", "MName", "Last Name", "Alexxxx", "Company", "13 Elm Street", "+81245678921"));
    submitNewUser();
    goToHomePage();
  }
  ...
  private void fillNewUserForm(UserData userData) {
    ...
    wd.findElement(By.name("address")).sendKeys(userData.getStreet());
    wd.findElement(By.name("home")).click();
    wd.findElement(By.name("home")).clear();
    wd.findElement(By.name("home")).sendKeys(userData.getTel());
  }
